...
download. Every valid row respects ``SCHEMA_MAP.md v2`` (1–3 family
dwellings, where NYC.gov's GROSS SQUARE FEET is the home's own footage and
therefore comparable to the Kaggle PROPERTYSQFT the benchmark model learned
from); every drop reason in the v2 drop engine is exercised by at least one
row, including ``not_family_dwelling`` (condos/coops/commercial).
"""
...
def nyc_rolling_sales_fixture() -> pd.DataFrame:
    ...
    rows = [
        ...
        {"BOROUGH": 1, "BUILDING CLASS CATEGORY": "13 CONDOS - ELEVATOR APARTMENTS",
         "GROSS SQUARE FEET": 1400, "LAND SQUARE FEET": 2000,
         "YEAR BUILT": 1925, "ZIP CODE": 10001, "SALE PRICE": 1_400_000},
        {"BOROUGH": 2, "BUILDING CLASS CATEGORY": "10 COOPS - ELEVATOR APARTMENTS",
         "GROSS SQUARE FEET": 1800, "LAND SQUARE FEET": 2400,
