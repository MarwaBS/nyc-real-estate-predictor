...
#
# libgomp1 is the OpenMP runtime scikit-learn and the boosting wheels link
# against. Without it
...
# runtime image.
#
# The /health smoke test below verifies this: it loads the model, so a
# missing libgomp1 turns the docker-build job red rather than shipping a
# container that 503s.
#
# CACHE_EPOCH (set to
